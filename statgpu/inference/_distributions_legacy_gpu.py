...
def t_cdf_gpu(x, df):
    ...
    from ._distributions_backend import t
...
def norm_cdf_gpu(x):
    ...
    from ._distributions_backend import norm
...
def dchisq_gpu(x, *shape_args, **kwargs):
    from ._distributions_backend import chi2
...
def dgamma_gpu(x, *shape_args, **kwargs):
    from ._distributions_backend import gamma
...
def dbeta_gpu(x, *shape_args, **kwargs):
    from ._distributions_backend import beta
...
def df_gpu(x, *shape_args, **kwargs):
    from ._distributions_backend import f
...
def dpois_gpu(k, *shape_args, **kwargs):
    from ._distributions_backend import poisson
...
def dbinom_gpu(k, *shape_args, **kwargs):
    from ._distributions_backend import binom
