...
class PenalizedLinearRegression(PenalizedGeneralizedLinearModel):
    ...
    def summary(self):
        ...
        if not self._compute_inference_enabled:
            raise RuntimeError('compute_inference=False: summary/inference statistics are not available. Re-fit with compute_inference=True to use summary().')
        ...
        for i, name in enumerate(feature_names):
            print(f'{name:<15} {self._params[i]:>12.4f} {self._bse[i]:>12.4f} {zvals[i]:>10.3f} {self._pvalues[i]:>10.4f} {self._conf_int[i, 0]:>12.4f} {self._conf_int[i, 1]:>12.4f}')
