...
by the thin wrapper over PenalizedLinearRegression in _lasso.py.

It is kept for reference and backward-compatibility testing only.
New code should use ``statgpu.linear_model.Lasso`` which delegates to
``PenalizedLinearRegression(penalty='l1')``.
"""
