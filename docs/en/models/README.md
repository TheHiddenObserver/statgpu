...
The Cox page is the authoritative source for Breslow/Efron/Exact ties,
delayed-entry and `(start, stop]` data, strata, robust/cluster inference,
subject-grouped CV, and the NumPy/CuPy/Torch support matrix.
