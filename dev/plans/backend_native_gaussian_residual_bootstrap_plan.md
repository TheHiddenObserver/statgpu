...
If implementation needs to propagate an already-existing bootstrap control across the CV final-refit reconstruction boundary, preserve that existing control by identity/semantics rather than adding an unrelated new public parameter in this PR.
