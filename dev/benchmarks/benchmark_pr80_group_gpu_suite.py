...
SOURCE_FILES = (
    ...
    *RUNNERS,
    ...
    "dev/tests/test_pr80_group_lasso_loss_contract.py",
    "dev/tests/test_pr80_group_lasso_solver_dispatch_contract.py",
    ...
    "dev/tests/test_pr80_group_penalty_clone_method_contract.py",
